  ...
  return (
    <>
      <div className="my-6 flex min-h-[80vh] w-[40vw] flex-col  gap-10 border-[0.2px] border-dotted border-pink-200	 px-4 py-4 shadow-lg">
        {/* <div > */}
        <div className=" text-center	text-2xl font-medium text-white	">Participants</div>
        ...
        <div className=" p-4 ">
          {arr.map((val, index) => {
            return (
              <>
                <div
                  className=" flex   justify-around items-center border-b-[0.01px] border-gray-300 p-4 "
                  key={index}
                >
